    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
         ...
         <?php 
           ...
           $query3 = "select sum( ((select sum(tiempo) from ajuste  where nommaquina = 'mesa 1' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC )+
         (select sum(tiempoTiraje) from tiraje where nombremaquina= 'mesa 1' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) -

        ((select sum(tiempoalertamaquina) from alertageneralajuste  where maquina = 'mesa 1' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)+
         (select sum(tiempoalertamaquina) from alertaMaquinaOperacion where nombremaquinaajuste= 'mesa 1' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) / 
         
         
         
         ((select sum(tiempo) from ajuste  where nommaquina = 'mesa 1' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)+
         (select sum(tiempoTiraje) from tiraje where nombremaquina= 'mesa 1' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC))
            ...
            $query = "SELECT SUM(buenos/entregados*100) / count(*) as calidad FROM tiraje where nombremaquina = 'mesa 1' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC ";
            ...
            $query2 = "SELECT SUM(entregados/cantidad*100) / count(*) as desempeno  FROM tiraje where nombremaquina = 'mesa 1' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC";
        ...
        var data = google.visualization.arrayToDataTable([
        	['', ''],
             <?php 
	        	...
	        	$query = "select ( ((select sum( ((select sum(tiempo) from ajuste where nommaquina = 'mesa 1' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)+ (select sum(tiempoTiraje) from tiraje where nombremaquina= 'mesa 1'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) - ((select sum(tiempoalertamaquina) from alertageneralajuste where maquina = 'mesa 1'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)+ (select sum(tiempoalertamaquina) from alertaMaquinaOperacion where nombremaquinaajuste= 'mesa 1'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) / ((select sum(tiempo) from ajuste where nommaquina = 'mesa 1'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)+ (select sum(tiempoTiraje) from tiraje where nombremaquina= 'mesa 1'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) ) *.1 / count(*) as disponibilidad) * (SELECT SUM(buenos/entregados*100) / count(*) as calidad FROM tiraje where nombremaquina = 'mesa 1' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC) * (SELECT SUM(entregados/cantidad*100) / count(*) as desempeno FROM tiraje where nombremaquina = 'mesa 1'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) *.00001 )as ete union (SELECT total   from ordenes where nommaquina= 'mesa 1')";
