...
<head>
    ...
    <title>AJUSTE SERIGRAFIA 1</title>
                ...
                <legend>TAREAS</legend>
                  <div class="col-md-6">                     
                    ...
                    <form id="tareas" action="opp.php" method="post" name="tareas">
                     ...
                     <?php
                      $query = $mysqli -> query ("SELECT * FROM ordenes where nommaquina = 'serigrafia 1' order by orden asc");
             ...
             <form id="fo3"name="fo3" action="saveAjsute.php" method="post" class="form-horizontal" onSubmit="return limpiar()" >
              ...
              <!-- Multiple Radios -->
                ...
                <div class="radio" style="left:20px; position:absolute; top:25px;">
                    <label for="radios-1">
                    <input type="radio" name="radios" id="radios-1" value="No Hay Material">
                    No Hay Material
                    </label>
                    </div>
