                ...
                <legend>TAREAS</legend>
                  <div class="col-md-6">                     
                    ...
                    <form id="tareas" action="opp.php" method="post" name="tareas">
                     ...
                     <?php
                      $query = $mysqli -> query ("SELECT * FROM ordenes where nommaquina = 'timbradora' order by orden asc");
             ...
             <form id="fo3"name="fo3" action="saveAjsute.php" method="post" class="form-horizontal" onSubmit="return limpiar()" >
              ...
              <!-- Multiple Radios -->
                ...
                <div class="radio"style="left:20px; position:absolute; top:50px;">
                    <label for="radios-2">
                    <input type="radio" name="radios" id="radios-2" value="Falta Albanene">
                    Falta Albanene
                    </label>
                    </div>
                <div class="radio" style="left:20px; position:absolute; top:75px;">
                    <label for="radios-3">
                    <input type="radio" name="radios" id="radios-3" value="Material Incompleto">
                    Material Incompleto
                    </label>
                    </div>
               <!-- <div class="radio"style="left:20px; position:absolute; top:100px;">
                    <label for="radios-4">
                    <input type="radio" name="radios" id="radios-4" value="Falta Matrix">
                    Falta Matrix
                    </label>
                    </div> -->
                </div>
