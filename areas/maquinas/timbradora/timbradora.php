    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
         ...
         <?php 
           ...
           $query3 = "select sum( ((select sum(tiempo) from ajuste  where nommaquina = 'timbradora' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC )+
         (select sum(tiempoTiraje) from tiraje where nombremaquina= 'timbradora' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) -

        ((select sum(tiempoalertamaquina) from alertageneralajuste  where maquina = 'timbradora' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)+
         (select sum(tiempoalertamaquina) from alertaMaquinaOperacion where nombremaquinaajuste= 'timbradora' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) / 
         
         
         
         ((select sum(tiempo) from ajuste  where nommaquina = 'timbradora' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)+
         (select sum(tiempoTiraje) from tiraje where nombremaquina= 'timbradora' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC))
            ...
            $query = "SELECT SUM(buenos/entregados*100) / count(*) as calidad FROM tiraje where nombremaquina = 'timbradora' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC ";
            ...
            $query2 = "SELECT SUM(entregados/cantidad*100) / count(*) as desempeno  FROM tiraje where nombremaquina = 'timbradora' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC";
        ...
        var data = google.visualization.arrayToDataTable([
        	['', ''],
             <?php 
	        	...
	        	$query = "select ( ((select sum( ((select sum(tiempo) from ajuste where nommaquina = 'timbradora' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)+ (select sum(tiempoTiraje) from tiraje where nombremaquina= 'timbradora'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) - ((select sum(tiempoalertamaquina) from alertageneralajuste where maquina = 'timbradora'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)+ (select sum(tiempoalertamaquina) from alertaMaquinaOperacion where nombremaquinaajuste= 'timbradora'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) / ((select sum(tiempo) from ajuste where nommaquina = 'timbradora'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)+ (select sum(tiempoTiraje) from tiraje where nombremaquina= 'timbradora'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) ) *.1 / count(*) as disponibilidad) * (SELECT SUM(buenos/entregados*100) / count(*) as calidad FROM tiraje where nombremaquina = 'timbradora' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC) * (SELECT SUM(entregados/cantidad*100) / count(*) as desempeno FROM tiraje where nombremaquina = 'timbradora'and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC)) *.00001 )as ete union (SELECT total   from ordenes where nommaquina= 'timbradora')";
...
<div class="contegral">
        ...
        <div class="row1"> 
         <?php
           ...
           //echo $valorQuePasa;
          $machine="SELECT * FROM maquina INNER JOIN asaichi ON maquina.mac = asaichi.mac WHERE nommaquina = 'Timbradora' and DATE(vdate) = DATE(NOW()) ORDER BY vdate DESC";  
           //echo $valorQuePasa;
            ...
            <div id="estilo">
             <form id="fo3"name="fo3" action="savealertamaquina.php" method="post" class="form-horizontal" onSubmit="return limpiar()" >
               ...
               <!-- Multiple Radios -->
                ...
                <div class="radio">
                    <label for="radios-3">
                    <input type="radio" name="radios" id="radios-3" value="Se Movio el Registro">
                    Se Movio el Registro
                    </label>
                    </div>
                <div class="radio">
                    <label for="radios-4">
                    <input type="radio" name="radios" id="radios-4" value="Planchado de Papel">
                    Planchado de Papel
                    </label>
                    </div>
                </div>
