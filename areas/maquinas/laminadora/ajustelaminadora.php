                ...
                <legend>TAREAS</legend>
                  <div class="col-md-6">                     
                    ...
                    <form id="tareas" action="opp.php" method="post" name="tareas">
                     ...
                     <?php
                      $query = $mysqli -> query ("SELECT * FROM ordenes where nommaquina = 'laminadora' order by orden asc");
          ...
          <div id="estilo">
             <form id="fo3"name="fo3" action="saveAjsute.php" method="post" class="form-horizontal" onSubmit="return limpiar()" >
                ...
                <div class="radio"style="left:20px; position:absolute; top:50px;">
                    <label for="radios-2">
                    <input type="radio" name="radios" id="radios-2" value="Material Incompleto Impreso">
                    Material Incompleto Impreso
                    </label>
                    </div>
                <div class="radio" style="left:20px; position:absolute; top:75px;">
                    <label for="radios-3">
                    <input type="radio" name="radios" id="radios-3" value="Falta Pelicula">
                    Falta Pelicula
                    </label>
                    </div>
                <div class="radio"style="left:20px; position:absolute; top:100px;">
                    <label for="radios-4">
                    <input type="radio" name="radios" id="radios-4" value="Limpieza de Rodillos">
                    Limpieza de Rodillos
                    </label>
                    </div>
                 <div class="radio"style="left:20px; position:absolute; top:125px;">
                    <label for="radios-4">
                    <input type="radio" name="radios" id="radios-4" value="Ajuste de Maquina">
                    Ajuste de Maquina
                    </label>
                    </div>    
                </div>
