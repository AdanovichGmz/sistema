                ...
                <form name="nuevo_registro" id="nuevo_registro" method="POST" action="index3.php">
                 ...
                 <input hidden type="text" name="fechadeldia" id="fechadeldia" value="<?php echo date("d-m-Y"); ?>" />
                    ...
                    <div class="modal-content" style="">
                        ...
                        <div class="square-button yellow stop eatpanel goeat">
                          <img src="images/dinner.png">
                        </div>
                        <div id="stop" class="square-button green" >
                          <img src="images/saving.png">
                        </div>
                        <div class="square-button blue derecha goalert">
                          ...
                          <img src="images/checklist.png">
                            ...
                            <div class="row" style="display: none;">
                               <div class="col-lg-2  col-sm-2 col-sm-offset-1 ">
                                  <a href="logout.php" > <img src=""  href="logout.php" class="img-responsive" onClick="return confirm('estas segur@ de cerrar SESION?')" /></a>
            
                                </div> 
                                <div class="col-lg-2  col-sm-2 ">
                                    
                                  <img  type="image" name="comer" src="" class="stop img-responsive eatpanel goeat" />
                                   
                                </div> 
                                <div class="col-lg-2 col-sm-2 ">
                                    <input id="stop" type="image" name="eviar" value="Registrar" src="" class="img-responsive "  />
                                </div>
                                <div class="col-lg-2 col-sm-2 ">
                            ...
                            <div class="row">
                                ...
                                <div class="reloj-container">
                                    <div id="reloj" class="clock" style=""></div>
                                    <script>
                                            var clock;
                                            var ftime;
                ...
                <legend>TAREAS</legend>
                  <div class="col-md-6">                     
                    ...
                    <form id="tareas" action="opp.php" method="post" name="tareas">
                     ...
                     <?php
                      $query = $mysqli -> query ("SELECT * FROM ordenes where nommaquina = 'suaje' order by orden asc");
                      while ($valores = mysqli_fetch_array($query)) {
                      echo '<option value="'.$valores['numodt'].'">'.$valores['numodt'].'</option>';
                       }
                     ?>
                     </select>
                  </div>    
      ...
      <div class="container-fluid">
          ...
          <div id="estilo">
             <form id="fo3"name="fo3" action="saveeat.php" method="post" class="form-horizontal" onSubmit="return limpiar()" >
              ...
              <div class=" radio-menu face face-osc">
                <input type="radio" class="" name="radios" id="radios-0" value="Comida" checked="checked" >
                    COMIDA</div>
               <div class=" radio-menu face">
