...
$tbody.='<tr class="theader">';
    ...
    $tbody.='<td>GRAN TOTAL</td>';
      ...
      foreach ($workProc as $key => $workPrice) {
        $tbody.="<td> COSTO ".substr($workPrice['nombre_proceso'], 0, 4)."</td>";
      }
...
$diferencia=($precios+($sum_largos*0.20))-$user['sueldo'];
  ...
  $tbody.='</tr>';
  $tbody.='</tbody></table><div class="clearfix"></div>';
  $table.=$tbody;
...
<script type="text/javascript" src="../js/libs/FileSaver/FileSaver.min.js"></script>
 <script type="text/javascript" src="../js/libs/tableExport.js"></script>
  <style>
  @page{margin:1.3em}.info{font-family:Arial,Helvetica,sans-serif;border-collapse:collapse;width:100%;text-align:center;font-size:7px}.info td{border:1px solid #ccc;padding:1px}.info tbody>tr:nth-child(even){background-color:#EBEBEB}.oper{font-size:10px!important;text-align:left!important}.oper td{padding:1px 2px!important}.theader{text-transform:uppercase;text-align:center;background-color:#000;color:#fff;font-size:5px}.clearfix{width:100%;height:10px}.results{background: #a9a6a6;}
