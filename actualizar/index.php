...
<p style="font-size: 30px; color: #666666;margin:10px auto;">Actualizar Estatus</p>
    <div class="ete-stat">
    <form  method="post" id="bulk">
      <table>
      <thead>
      <tr class="trh">
        <td colspan="2"><input type="submit" class="genpdf btn btn-primary" value="Actualizar"></td>
