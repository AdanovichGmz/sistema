...
if(@$_SESSION['logged_in'] != true){
  ...
  <?php
     ...
     $maquinas="SELECT nommaquina, idmaquina FROM maquina order by nommaquina asc";
      $n_maquinas=$mysqli->query($maquinas);
      $usuarios="SELECT * FROM login order by logged_in asc";
...
<body style="">
    ...
    <header>
      ...
      <li><a href="reporteindex.php">Inicio</a></li>
        ...
        <li class="lefting nohover">
          <span class="labels"><div id="hora" class="lightbox" ></div></span>
        </li>
  ...
  <div class="div-tabla">
  <div id="conttabla" class="conttabla" >    
    <div class="datagrid" >
    <?php include("reporteTable.php");  ?>
    </div>
    </div>
  </div>
  ...
  <p id="order" style="text-align: center; font-weight: bold;"></p>
    ...
    <input type="hidden" value="ajuste" name="form" >
   <input type="hidden" id="fi" name="idajuste" >
