...
<?php include("topbar.php");  ?>
 ...
 <div class="top-form">
  ...
  <div class="left-form2">
   ...
   <p style="margin-bottom: 2px!important;">Elige una fecha</p>
   <input type="hidden" name="activef" value="ok">
   <div class="">

 <input id="datepicker" class="" placeholder="Fecha.." name="fecha" required="true" value="" name="id" />
...
<div class="div-tabla">
<div class="w-message">
  Por favor selecciona una fecha, luego haz click en <strong>TRAER INFORMACION</strong>
</div>
</div>
