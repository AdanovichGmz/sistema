...
<head>
    ...
    <meta name="viewport" http-equiv="refresh" content="30" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
...
<div class="box2"><div class="close2">x</div>
  ...
  <p id="orderdelete" style="text-align: center; font-weight: bold;"></p>
    ...
    <input type="hidden" value="encuesta" name="form" >
...
<div class="backdrop"></div>
  ...
  <p id="order" style="text-align: center; font-weight: bold;"></p>
    ...
    <input type="hidden" value="encuesta" name="form" >
   <input type="hidden" id="fi" name="idencuesta" >
    ...
    <input type="text" id="fh" name="hora" placeholder="Hora del dia">
    <input type="text" id="ff" name="fecha" placeholder="Fecha">
    <input type="text" id="fd" name="desemp" placeholder="Desempeño">
    <input type="text" id="fp" name="problema" placeholder="Problema">
    <input type="text" id="fc" name="calidad" placeholder="Calidad">
    <input type="text" id="fpp" name="problema2" placeholder="Problema 2">
