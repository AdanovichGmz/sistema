...
//	$bd_usuario = "root"; 
	...
	$query="SELECT * FROM ajuste inner join tiraje on ajuste.logged_in = tiraje.logged_in inner join ordenes on ordenes.numodt = tiraje.numodt";
	...
	*/ 
	...
	$resSql=mysqli_query($query) or die("<br>Error consulta</br>".mysql_error());
	
$pdf = new Cezpdf('A4');
$pdf->selectFont('fonts/comicbd.ttf');
