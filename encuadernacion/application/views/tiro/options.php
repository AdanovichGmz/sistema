...
<div class="elem-process picable normal <?=($count>30)? 'fit-process':'' ?>" data-option="<?=$child['id_proceso'] ?>" data-user="<?=$_POST['user'] ?>" data-sname="<?=$key1 ?>" data-pname="<?=$child['n_proceso'] ?>" data-station="28">
<span>
	<?=$child['n_proceso'];?>
