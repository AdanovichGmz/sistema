...
<li ><a class="active" href="#">Proceso: <span><?= preg_replace('/\s+/', '', $process_model->getProcessName($_SESSION['teamSession'][$_POST['user']]['memberProcessID'])) ?></span></a></li>
  <li><a  href="#">Produccion: <span><?=$ete_model->getBuenos($_POST['user'],$_SESSION['sessionID']); ?></span></a></li>
  <li><a href="#">Merma: <span><?=$ete_model->getMerma($_POST['user'],$_SESSION['sessionID']); ?></span> </a></li>
...
<div id="change-activity" data-msession="<?=$_SESSION['teamSession'][$_POST['user']]['memberSessionID'] ?>" data-user="<?=$_POST['user'] ?>" class="m-button purple">
 ...
 <table>
   ...
   <tr>
     <td><input type="number" name="pedido" id="pedido" onclick="getKeys(this.id,'pedido')"></td>
     <td><input type="number" name="buenos" id="buenos" onclick="getKeys(this.id,'buenos')"></td>
   </tr>
   <tr>
   ...
   <tr>
     <td><input type="number" name="recibidos" id="recibidos" onclick="getKeys(this.id,'recibidos')"></td>
     <td><input type="number" name="ajuste" id="ajuste" onclick="getKeys(this.id,'ajuste')"></td>
   </tr>
   <tr>
     <td>MERMA</td>
     <td>DEFECTOS</td>
   ...
   <tr>
     <td><input type="number" name="merma" id="merma" onclick="getKeys(this.id,'merma')"></td>
     <td><input type="number" name="defectos" id="defectos" onclick="getKeys(this.id,'defectos')"></td>
   </tr>
 </table>
</form>
