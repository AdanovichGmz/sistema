...
<li ><a class="active" href="javascript:void(0)">Proceso: <span><?= preg_replace('/\s+/', '', $process_model->getProcessName($_SESSION['teamSession'][$_POST['user']]['memberProcessID'])) ?></span></a></li>
