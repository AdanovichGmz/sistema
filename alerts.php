...
switch ($mac){
  ...
  case '5c:f5:da:2f:33:5e':
       ...
       $options[]= 'Cambio de Cuchilla';
       $options[]= 'Pieza de Plancha' ;
       $options[]= 'Exceso de Dimensiones' ;
        break;
  ...
  case '90:b9:31:ed:0f:6b':
         $options[]='ODT Confusa';
       $options[]='ODT Faltante' ;
       $options[]= 'No hay Tabla';
       $options[]= 'Papel Incompleto' ;
       $options[]= 'Falta Matrix' ;
    //echo $nommaquina;
        break;
  ...
  case 'b0:34:95:01:ec:2b':
        ...
        $options[]='ODT Confusa';
       $options[]='ODT Faltante' ;
       $options[]= 'Material Incompleto Impreso';
       $options[]= 'Falta Pelicula' ;
       $options[]= 'Limpieza de Rodillos' ;
